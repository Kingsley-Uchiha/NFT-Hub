  ...
  return (
    <header className="py-10 px-24">
      ...
      <div className="numbers flex items-start gap-3">
        ...
        <Image src="/star.png" width={20} height={20} alt="" className="mt-2" />
        <div className="flex flex-col items-center">
      ...
      <div className="users pt-20 flex items-center gap-4">
        <div className="imgs flex relative">
          <Image src="/user1.png" width={40} height={40} alt="" className="mr-10" />
          <Image src="/user2.png" width={40} height={40} alt="" className="absolute ml-5" />
          <Image src="/user3.png" width={40} height={40} alt="" className="absolute ml-10" />
        </div>
        <div className="">
